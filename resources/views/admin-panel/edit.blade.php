...
@section('content')
    <div class="bg-gray-400 rounded p-10 w-1/2 flex flex-col justify-center items-center m-auto">
        ...
        {{ Form::text('text', $quotes->movies->name, ['class' => 'p-2 border border-primary rounded mb-2 outline-none bg-indigo-50']) }}
